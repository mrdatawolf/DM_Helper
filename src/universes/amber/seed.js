...
function seed(db, campaignId) {
    const insertShadow = db.prepare(`
        INSERT OR IGNORE INTO shadows
            (name, description, order_level, chaos_level, dream_level, pattern_influence, corruption_status, is_starting_shadow, campaign_id)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
    `);
